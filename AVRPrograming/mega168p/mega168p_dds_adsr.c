 ...
 *
 ...
 ADSR Dynamic Volume Envelope
 * Created: 2017/01/09 2:50:41
 * Author : Someonesgarden
 */ 


// ------- Preamble -------- //
#include "../lib/adsr.h"             /* Defines, includes, and init functions */

int mega168p_dds_adsr(void) {
  ...
  while (1) {
    ...
    mixer = fullSaw15[waveStep] * volume;
    mixer = mixer >> 5;
